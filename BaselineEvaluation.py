    ...
    for network in network_params:
        ...
        if network in test_set:
            ...
            for id in range(num_graph):
                ...
                graph_path = os.path.join(TEST_DATASET_PATH, network_type + '_graph', network, network_name + '.txt')
                label_path = os.path.join(TEST_LABELS_PATH, network_type + '_graph', network, network_name + '_labels' + ".txt")
